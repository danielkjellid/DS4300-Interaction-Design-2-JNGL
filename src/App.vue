<template>
  <div id="app">
    <div class="mobile">
      <div class="mobile-skin">
        <div class="skin-overlay"></div>
        <div class="mobile-viewport">
          <div class="bg-gray-100 canvas">
            <!-- header -->
            <header class="bg-gray-800 shadow-md header">
              <div class="flex items-center justify-center px-5 py-6">
                <router-link class="flex items-center block text-sm font-medium text-white" to="/position">
                  <a class="flex">
                    Velg posisjon
                    <svg viewBox="0 0 20 20" fill="currentColor" class="w-6 h-6 ml-2 text-gray-400">
            ...
            <nav class="sticky bottom-0 z-40 bg-white border-t border-gray-300 shadow nav">
              <div class="flex items-center justify-between px-5 pt-4 pb-6">
                <router-link to="/" class="block text-sm font-medium text-gray-600 hover:text-gray-800" active-class="text-gray-800" exact>
                  <svg viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6 m-auto mb-1 text-gray-400" :class="{'text-gray-600' : parentIsActive('/')}">
                ...
                <router-link to="/list" class="block text-sm font-medium text-gray-600 hover:text-gray-800" active-class="text-gray-800">
                  <svg viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6 m-auto mb-1 text-gray-400 hover:text-gray-600" :class="{'text-gray-600' : parentIsActive('/list')}">
                ...
                <router-link to="/favorites" class="block text-sm font-medium text-gray-600 hover:text-gray-800" active-class="text-gray-800">
                  <svg viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6 m-auto mb-1 text-gray-400 hover:text-gray-600" :class="{'text-gray-600' : parentIsActive('/favorites')}">
...
<style>
  ...
  .skin-overlay {
    background: url('./assets/images/iphone-screen.png');
    background-size: 100%;
    position: absolute;
    width: 100%;
    height: 100%;

  ...
  <div>
      <div v-if="place">
          ...
          <div class="px-5 py-5">
            ...
            <!-- modal code -->
            <div class="absolute top-0 left-0 w-full h-full bg-black opacity-25 cursor-pointer">
              
            </div>
            <div class="absolute left-0 right-0 bg-white border-t border-gray-300 nav-padding rounded-custom">
              ...
              <div class="px-5 py-5">
                ...
                <textarea v-model="reviewText" id="review" class="block w-full mt-2 text-sm text-gray-700 bg-gray-100 border border-gray-300 rounded-md form-input" rows="4" placeholder="Skriv inn anmeldelsen her"></textarea>
                <div class="mt-5">
                  <button class="w-full py-3 text-sm text-center text-gray-800 bg-gray-200 rounded hover:text-gray-900 hover:bg-gray-300">
                    Fortsett
                  </button>
              ...
              <div class="px-5 py-5">
                <div class="border-b border-gray-300">
                  <button class="flex items-center justify-center w-full py-3 mb-5 text-sm text-gray-800 bg-white border border-gray-300 rounded hover:bg-gray-100 hover:text-gray-900">

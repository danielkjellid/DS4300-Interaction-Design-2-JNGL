<template>
    <div>
        <div class="px-5 py-5 bg-white shadow">
            ...
            <div v-if="!!this.getRegret()" class="flex flex-row mx-5 mt-5 p-3 text-xs justify-center items-center bg-white rounded"> 
                ...
                <div class="pl-3 pr-3">
                   ...
                   <button @click="handleRegret(false)" class="absolute x-out">

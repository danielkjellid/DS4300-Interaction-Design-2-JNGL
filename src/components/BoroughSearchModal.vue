...
<div>
    ...
    <div class="absolute left-0 right-0 bg-white border-t border-gray-300 bottom-hackey">
      ...
      <div v-show="filterActive" class="flex items-center justify-between px-5 py-5 border-t border-gray-300" v-for="borough in filteredBoroughs.slice(0, 3)" :key="borough.id">

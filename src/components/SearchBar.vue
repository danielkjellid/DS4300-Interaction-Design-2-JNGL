<template>
  <div>
    <div :class="showFilter ? 'flex items-center justify-between' : 'w-full'">
      ...
      <div v-if="showFilter" class="flex items-center justify-between px-2 py-2 text-gray-500 bg-white border border-gray-300 rounded-md">
        ...
        <svg viewBox="0 0 20 20" fill="currentColor" class="w-6 h-6" id="dropArrow">

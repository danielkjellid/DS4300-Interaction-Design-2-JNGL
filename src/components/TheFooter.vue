<template>
  <!-- component to display app's navigational footer -->
  <footer class="sticky bottom-0 z-40 bg-white border-t border-gray-300 shadow nav">
    <nav class="flex items-center justify-between px-5 pt-4 pb-6">
      <!-- link to each route specified in /router/routes.js -->
      ...
      <router-link to="/profile/3" class="block text-sm font-medium text-gray-600 hover:text-gray-800" active-class="text-gray-800">

<template>
  <!-- component to indicate to user that no data is found -->
  <div>
    <div class="flex justify-center ">
      <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="140" viewBox="0 0 820.16 780.81">
        <defs>
        ...
        <rect x="375.66" y="136.55" width="199.84" height="47.27" transform="translate(-212.94 43.72) rotate(-12.11)" fill="#2d3748" />
        <path d="M460.93,91.9a27.93,27.93,0,1,0,33.17,21.45A27.93,27.93,0,0,0,460.93,91.9ZM470.17,135a16.12,16.12,0,1,1,12.38-19.14A16.12,16.12,0,0,1,470.17,135Z" transform="translate(-189.92 -59.59)" fill="#2d3748" />
        ...
        <rect x="377.02" y="104.56" width="199.84" height="47.27" fill="#2d3748" />
        <path d="M666.86,118a27.93,27.93,0,1,0,27.93,27.93A27.93,27.93,0,0,0,666.86,118Zm0,44.05A16.12,16.12,0,1,1,683,145.89,16.12,16.12,0,0,1,666.86,162Z" transform="translate(-189.92 -59.59)" fill="#2d3748" />
        <g opacity="0.5">
    ...
    <p class="mt-4 text-sm text-center text-gray-600">{{ text }}</p>
  </div>
</template>
